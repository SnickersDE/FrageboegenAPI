    ...
    <div className="col" style={{ gap: 48 }}>
      ...
      >
        ...
        <div className="col" style={{ gap: 24 }}>
          ...
          >
            {showStudyDetails ? "Weniger zur Studie anzeigen" : "Mehr zur Studie erfahren"}
          </button>
          ...
          <>
            ...
            <div className="panel col">
              <label style={{ fontWeight: "bold", marginBottom: 8 }}>Thema wählen:</label>
              <select 
                className="input" 
                value={selectedTopic} 
              ...
              >
                ...
                <option value="theorie">Theoretische Überlegungen zum Fragebogendesign</option>
                <option value="kritik">Kritik</option>
                <option value="hypothesen">Hypothesenlogik</option>
                <option value="berechnung">Berechnung des Schichtindex</option>
              </select>
            </div>

            {selectedTopic === "theorie" && (
              <div className="panel col">
                ...
                <p>
                  Die zusätzliche Erhebung der subjektiven Einschätzung der eigenen sozialen Schicht trägt der bourdieuschen Annahme Rechnung, dass soziale Praxis nicht allein durch objektive Positionen bestimmt wird, sondern durch den Habitus, also durch verinnerlichte Wahrnehmungs-, Denk- und Bewertungsschemata. Subjektive Statuszuordnungen beeinflussen Bildungs- und Berufsaspirationen sowie Handlungserwartungen und sind damit insbesondere für Analysen geschlechtsspezifische Ungleichheit von zentraler Bedeutung. Der entwickelte Index im Wertebereich von 0 bis 5 ermöglicht es, objektive und subjektive Dimensionen sozialer Lage systematisch zu vergleichen und Wahrnehmungsdiskrepanzen zwischen sozialer Position und Selbsteinordnung empirisch zu erfassen.
                </p>
                <p>
